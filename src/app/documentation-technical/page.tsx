    ...
    <Layout
      ...
      content={
        <LayoutContent isScrollable={false} padding={8}>
          <VStack gap={8}>
            <VStack gap={2}>
              <Text type="display-1">Getting started with peQL</Text>
            ...
            <Card>
              <VStack gap={3}>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      void navigator.clipboard.writeText(
                        'Help me get set up with peQL. Based on my project, do the following: 1. Install @astryxdesignthe peQL Rust crate. 2. Wrap my app in ThemeProvider. 3. Replace one existing component with an Astryx equivalent. After setup, suggest relevant next steps based on my project.',
                      );
                    }}
                  />
                  <DropdownMenu
                ...
                <Text type="body" color="secondary">
                  Help me get set up with peQL. Based on my project, do
